...
CREATOR_TEMPLATES = [
    ...
    {"id": "viral-tiktok", "name": "Viral TikTok", "creator": "TikTok Trends",
     ...
     "color_grade": "vibrant", "speed_ramp": True, "speed_ramp_type": "speedup"},
    {"id": "cinematic-gold", "name": "Cinematic Gold", "creator": "Film Makers",
     "description": "Golden cinematic look, slow fades, dramatic",
     "badge": "🎬 CINEMA", "badge_color": "text-amber-300",
     "style_id": "cinematic_gold", "animation": "fade_slow", "zoom_style": "breathing",
     "color_grade": "cinematic", "speed_ramp": False, "speed_ramp_type": "none"},
    {"id": "comedy-fun", "name": "Comedy Fun", "creator": "Comedy Creators",
     "description": "Playful, colorful, bounce animations",
     "badge": "😂 COMEDY", "badge_color": "text-yellow-400",
     "style_id": "comedy", "animation": "bounce", "zoom_style": "punch",
     "color_grade": "vibrant", "speed_ramp": False, "speed_ramp_type": "none"},
]
