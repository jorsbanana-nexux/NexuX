...
class EditorialMemoryEvent:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {"schema_version": SCHEMA_VERSION, "event_id": item.event_id, "user_id": item.user_id, "signal": item.signal, "value": item.value, "context": dict(item.context), "created_at": item.created_at, "source": item.source}
