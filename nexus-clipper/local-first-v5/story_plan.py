...
def build_story_plan(
    *,
    ...
    plan = StoryPlan(
        ...
        promise_payoff_integrity=_clamp(promise_payoff_integrity),
        context_integrity=_clamp(context_integrity),
        retention_estimate=_clamp(retention_estimate),
        visual_feasibility=_clamp(visual_feasibility),
        audio_feasibility=_clamp(audio_feasibility),
