...
def test_adaptive_context_expands_until_payoff_is_found() -> None:
    ...
    assert result.stop_reason in {"sufficient_evidence", "resolved_with_low_uncertainty", "max_radius_reached"}


def test_adaptive_context_reports_uncertainty_when_no_payoff_exists() -> None:
    transcript = {
        "segments": [
